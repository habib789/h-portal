...
@section('content')
    ...
    <a href="{{ route('pending.appointment') }}">Pending Appointments</a>
    <div class="row">
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        @foreach($appReports as $app_report)
                            <tr>
                                ...
                                <td>{{ $app_report->created_at->format('d-m-Y') }}</td>
                                <td>Dr. {{ $app_report->doctor->first_name }} <br>
                                    <small>Dept: {{ $app_report->department->name }}</small></td>
                                <td>
                        ...
                        <tr>
                            ...
                            <td class="text-info font-weight-bold text-center">
                                <h4>Total BDT {{ number_format($appReports->sum('appointment_fee'),2) }} TK</h4>
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td></td>
                            <td class="text-info font-weight-bold text-center">
                                <h4>Total Profit BDT {{ number_format($profit,2) }} TK</h4>
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
...
{{--                            <tr>--}}
{{--                                @foreach($appDepts as $appDept)--}}
{{--                                <td>--}}
{{--                                    <div class="card-header">--}}
{{--                                        <h5>{{ $appDept->department->name }}</h5>--}}
{{--                                    </div>--}}
{{--                                </td>--}}

{{--                                <td>--}}
{{--                                    <p>{{ $appDepts->sum('appointment_fee') }}</p>--}}
{{--                                </td>--}}
{{--                            </tr>--}}
{{--                        @endforeach--}}
